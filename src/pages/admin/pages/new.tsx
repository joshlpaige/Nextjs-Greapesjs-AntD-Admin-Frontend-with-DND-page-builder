...
const html = `<body>
<header id="if21" class="header-banner">
    <div class="container-width">
        <div class="logo-container">
            <div class="logo">GrapesJS</div>
        </div>
        <nav class="menu">
            <div id="i06s" class="menu-item">BUILDER</div>
            <div id="iujo" class="menu-item">TEMPLATE</div>
            <div id="i0jfs" class="menu-item">WEB</div>
        </nav>
        <div class="clearfix"></div>
        <div class="lead-title">Build your templates without coding</div>
        <div class="sub-lead-title">
            All text blocks could be edited easily with double clicking on it. You can create new text blocks with the
            command from the left panel
        </div>
...
<section class="blk-sect">
    <div class="container-width">
        ...
        <div class="blk-desc">
            Each element in HTML page could be seen as a block. On the left panel you could find different kind of blocks
            that you can create, move and style
        </div>
...
const PageBuilder = () => {
    ...
    const savePage = async (editor: grapesjs.Editor) => {
        ...
        const uid = uniqueId();
        await pageApi.savePage({ uid: uid, title: 'untitled', status: 'draft', html: f, css: css as string });
        Router.push(`/admin/pages/${uid}`);
    };
